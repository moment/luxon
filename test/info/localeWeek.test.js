...
test.skipIf(isMissingLocaleWeekInfo)("Info.getWeekendWeekdays reports the correct value", () => {
...
test.skipIf(isMissingLocaleWeekInfo)("Info.getStartOfWeek honors the default locale", () => {

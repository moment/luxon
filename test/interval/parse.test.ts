...
import { FromDateTimeToObject } from "../../src/types/datetime";
...
test("Interval.fromISO can parse a variety of ISO formats", () => {
  const check = (s: string, ob1: FromDateTimeToObject, ob2: FromDateTimeToObject) => {
...
test("Interval.fromISO accepts a zone argument", () => {
  const dateDate = Interval.fromISO("2016-01-01/2016-12-31", {
    zone: "Europe/Paris",
  });

...
test("DateTime#toLocaleString() accepts correctly altered presets", () => {
  expect(dt.toLocaleString(DateTime.DATETIME_MED)).toBe("May 25, 1982, 9:23 AM");
  expect(
    dt.toLocaleString({
      ...DateTime.DATETIME_MED,
      hour: "2-digit",
    })
  ).toBe("May 25, 1982, 09:23 AM");
});

test("DateTime#toLocaleString() throws for incorrectly used arguments", () => {
  expect(() =>
    dt.toLocaleString({
      ...DateTime.DATETIME_MED,

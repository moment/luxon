...
1. Luxon lacks the relative time features of Moment and will wait until the required [facilities](https://github.com/tc39/proposal-intl-relative-time) are provided by the browser.

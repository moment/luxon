...
| From custom format      | `moment(String, String)` | `DateTime.fromString(String, String)` | The format tokens differ between Moment and Luxon, such that the same format string cannot be used between the two.             |

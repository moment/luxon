...
For more on validity and how to debug it, see [errors](errors.md). You may find more comprehensive tips there. But as it applies specifically to `fromFormat`, again try `fromFormatExplain`:

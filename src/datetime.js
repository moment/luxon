...
export default class DateTime {
   ...
   * @example DateTime.fromObject({ hour: 10, minute: 26, second: 6, zone: 'system' })
   ...
   * @param {string|Zone} [zone='local'] - a zone identifier. As a string, that can be any IANA zone supported by the host environment, or a fixed-offset name of the form 'utc+3', or the strings 'local', 'system', or 'utc'. You may also supply an instance of a {@link Zone} class.

...
export default class DateTime {
   ...
   * @param opts
   * @param {string|Zone} [opts.zone='default'] - interpret the numbers in the context of a particular zone. Can take any value taken as the first argument to setZone()

...
import { InfoCalendarOptions, InfoOptions, InfoUnitOptions } from "./types/info";
...
export default class Info {
  ...
  static months(
    ...
    }: InfoCalendarOptions & { locObj?: Locale } = {}
  ): string[] {
  ...
  static weekdays(
    ...
    { locale, numberingSystem, locObj }: InfoUnitOptions & { locObj?: Locale } = {}
  ): string[] {
   ...
   * @return {Object}
   */
  static features(): { relative: boolean } {
